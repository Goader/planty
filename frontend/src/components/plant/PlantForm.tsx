...
type PlantFormProps = {
  onSubmit: (
    data: PlantFormData,
    helpers: FormikHelpers<PlantFormData>
  ) => void;
...
export default function PlantForm(props: PlantFormProps) {
  ...
  const [showInstructionList, setShowInstructionList] =
                ...
                <Form.Control
                  ...
                  onChange={(event) => {
                    ...
                    if (target.files === null) {
                      ...
                      toBase64(target.files[0]).then((value) => {
              ...
              <Col xs={12} sm={12} md={12} lg={6}>
                <Form.Group className={"auth-group"}>
                  ...
                  <div className={"d-flex"}>
                    ...
                    <div>
                      <Button onClick={() => setShowInstructionList(true)}>
                        Select instruction
                      </Button>
                    </div>
                  </div>
